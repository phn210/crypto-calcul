...
typedef enum
{
    AES_KEY_SIZE_128 = 16, // 128-bit key
    AES_KEY_SIZE_192 = 24, // 192-bit key
    AES_KEY_SIZE_256 = 32  // 256-bit key
} AES_KEY_SIZE;
...
void aes_add_round_key(unsigned char state[4][4], unsigned char *round_key);
...
// AES constants
static const unsigned AES_SBOX[16][16] = {
...
static const unsigned INVERSE_AES_SBOX[16][16] = {
...
static const unsigned MIX_COLUMN_MATRIX[4][4] = {
    {2, 3, 1, 1},
    {1, 2, 3, 1},
    {1, 1, 2, 3},
    {3, 1, 1, 2}};

static const unsigned INVERSE_MIX_COLUMN_MATRIX[4][4] = {
    {0x0e, 0x0b, 0x0d, 0x09},
    {0x09, 0x0e, 0x0b, 0x0d},
    {0x0d, 0x09, 0x0e, 0x0b},
    {0x0b, 0x0d, 0x09, 0x0e}};
...
static const unsigned GF_MUL_TABLE[15][256] = {
    {},
    {},
