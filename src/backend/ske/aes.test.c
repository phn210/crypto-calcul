...
int main()
{
    ...
    char *input_file = "./src/backend/ske/test/aes_input_file.txt";
    char *encrypted_file = "./src/backend/ske/test/aes_output_encrypted_file.txt";
    char *decrypted_file = "./src/backend/ske/test/aes_output_decrypted_file.txt";
